...
言归正传，我们接着考虑上节课的问题**求和 1~100 之间的整数**
`;
...
console.log(sumUp(1000)); // 1~1000 中的整数和
console.log(sumUp(10000)); // 1~10000 中的整数和
...
`;
...
console.log(sumUp(50, 1000)); // 50~1000 中的整数和
console.log(sumUp(8, 54)); // 8~54 中的整数和
...
`;
