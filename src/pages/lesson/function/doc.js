...
- 如果你以前没有代码基础，但能对之前所有代码测试小题目都能又快又简洁地实现出来，那么恭喜你，你的学习效率和逻辑能力真的很棒！请继续往后进行。
- 没有第一时间做出来，但能看懂参考答案的小伙伴也不必焦虑，因为你的表现还算正常，只是缺少练习。这里准备了一些题目一定要好好做（[开始练习](/lesson/practice)）。
- 对于一头雾水的小伙伴，需要仔细理解教程中的每一句话，不要忽略每一个字，有任何疑问就应当立马停下来。建议回到 **综述 > Javascript > 数据类型** 处重新学习，否则后面会很被动。等再次到这个位置时，认真对待练习题目。
`;
