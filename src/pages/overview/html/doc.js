...
这些标签之外的部分也建议了解一下[更多](https://www.w3school.com.cn/tags/tag_a.asp)，事实上真正用框架写项目的时候，直接使用的原生标签类型已经不多了。所以初学者知道有这么些东西，知道使用标签的规则即可。
...
HTML 的内容其实就这么多，就像英语单词，常用的记一下，接下来就是用了。
`;